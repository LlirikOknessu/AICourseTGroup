...
def clean_data(df: pd.DataFrame) -> pd.DataFrame:
    # Example of data preparation: handling missing values and encoding categorical variables
...
if __name__ == '__main__':
    ...
    for data_file in input_dir.glob('*.csv'):
        ...
        # Replace 'median_house_value' with the actual target column name
        X, y = cleaned_data.drop("median_house_value", axis=1), cleaned_data['median_house_value']
