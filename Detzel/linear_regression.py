...
if __name__ == '__main__':
    ...
    #y_pred_baseline = [y_mean] * len(y_test)  изменить baseline на нормальное распределение
    ...
    intercept = pd.Series(intercept, name='intercept') #смещение линейной регрессии
